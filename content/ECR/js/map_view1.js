...
let map_view = function()
{
	...
	/* The progress bar on clicking Submit*/
	...
	self.year = 0; // Holds the category of input year
	self.cancerSiteGrp = 0; // Holds the category of input cancer site group
	self.age = 0; // Holds the category of input age
	...
	self.updateMap = function() 
	{
	    ...
	    {
	    	case "2006 - 2010": self.year = 1;
	    						break;
			case "2011 - 2015": self.year = 2;
								break;
			default: self.year = 0;
	    }
	    ...
	    {
	    	case "Colorectal": self.cancerSiteGrp = 1;
	    						break;
			case "Lung and Bronchus": self.cancerSiteGrp = 2;
								break;
			case "Female Breast Invasive": self.cancerSiteGrp = 3;
											break;
			case "Cervix": self.cancerSiteGrp = 4;
							break;
	        case "Prostate": self.cancerSiteGrp = 5;
	        					break;
	        case "All other cancers": self.cancerSiteGrp = 6;
	        							break;
	        case "Female breast-insitu": self.cancerSiteGrp = 7;
	        								break;
			default: self.cancerSiteGrp = 0;
	    }
		
		switch(input_age.options[input_age.selectedIndex].value)
		{
			case "Less than 5": self.age = 1;
									break;
			case "5 - 14": 	self.age = 2;
							break;
			case "15 - 34":	self.age = 3;
							break;
			case "35 - 44":	self.age = 4;
							break;
			case "45 - 54": self.age = 5;	
							break;
			case "55 - 64":	self.age = 6;
							break;
			case "65 +":	self.age = 7;
							break;
			default: self.age = 0;
	...
	function startWorker() {
	    ...
	    if(typeof(Worker) !== "undefined") {
	        if(typeof(w) == "undefined") {
	           let message = {csg: self.cancerSiteGrp, a: self.age, y: self.year};
	           w = new Worker("/js/helper.js");
	        ...
	        w.onmessage = function(event) {
	            //console.log("Message Posted:"+event.data+" and worker thread terminated!");
	            w.terminate();
	...
	{	
		if(switch_data == 0)
		{
			...
			startWorker(); // Using this instead of calc_deaths()
			//calc_deaths();
